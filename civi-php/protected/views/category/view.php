			...
			<div class="span8" align="center">
				...
				<table class="table table-striped">
		 				...
		 				<?php 
							...
							{
								echo '<tr> <td> <img src= "'.Yii::app()->request->baseUrl.' /img/rectangle.php?data='.($i).'"> </td> <td>'.($i+1).'</td> <td>'.$ranking[$i]['realname'].'</td> <td>'.$ranking[$i]['weight'].'</td> <td>'.$ranking[$i]['percentBoard'].'%</td> <td>'.$ranking[$i]['percentUsers'].'%</td> <td>'.$ranking[$i]['slogan'].'</td> </tr>';
							}
						?>
					</table> 
			</div>
